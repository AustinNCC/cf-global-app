...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cf-global-app)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cf-global-app
```

A live public deployment of this template is available at [https://cf-global-app.templates.workers.dev](https://cf-global-app.templates.workers.dev)
